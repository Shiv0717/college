...
const facultyMembers = [
  ...
  },
  {
    ...
    projects: 8,
    rating: 4.5,
    email: "rajesh.sharma@kec.edu",
    phone: "+91-1234567893",
    bio: "Expert in thermal systems and robotics with extensive research experience. Committed to innovation in mechanical engineering."
  },
  {
    name: "Dr. Priya Patel",
    role: "Associate Professor",
    ...
    projects: 6,
    rating: 4.7,
    email: "priya.patel@kec.edu",
    phone: "+91-1234567894",
    bio: "Specialized in structural engineering with focus on sustainable construction practices and innovative design methodologies."
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1568992687947-868a62a9f521?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    publications: 12,
    projects: 5,
    rating: 4.4,
    email: "amit.singh@kec.edu",
    phone: "+91-1234567895",
    bio: "Passionate about data science and cloud technologies. Focuses on industry-relevant curriculum and student projects."
  },
  {
    ...
    projects: 11,
    rating: 4.9,
    email: "sunita.reddy@kec.edu",
    phone: "+91-1234567896",
    bio: "Expert in power systems and renewable energy with extensive research contributions. Committed to sustainable energy solutions."
  },
  {
    ...
    qualification: "M.Tech, B.Tech",
    experience: "10 years",
    specialization: "Communication Systems, IoT",
    image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    publications: 15,
    projects: 7,
    rating: 4.5,
    email: "vikram.malhotra@kec.edu",
    phone: "+91-1234567897",
    bio: "Specialized in communication systems and IoT technologies. Focuses on practical applications and industry partnerships."
  }
];
      ...
      <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 max-w-7xl mx-auto px-4">
        {filteredFaculty.map((faculty, index) => (
          ...
          >
            ...
            {/* Action Button */}
            <button className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-2.5 rounded-xl text-sm font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2 mx-auto">
              View Profile 
              <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
            </button>
