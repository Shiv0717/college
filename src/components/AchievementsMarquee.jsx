...
const CollegeDashboard = () => {
  ...
  const achievements = [
    ...
    { icon: Clock, title: "Average Package", value: "$128K", subtitle: "Annual CTC", color: "from-red-500 to-red-600" },
    { icon: Calendar, title: "Years Established", value: "139", subtitle: "Since 1885", color: "from-purple-500 to-purple-600" },
  ];
